Feature: Scheduled Post Ghost
  ...
  Scenario: As a user I want to create a scheduled post.
	...
	Then I click on element having xpath /html/body/div[2]/div/main/section/div/header/section/a
	Then I enter "<title>" into input field having css selector "textarea[placeHolder='Post Title']"
	Then I enter "<content>" into input field having css selector "p[data-koenig-dnd-droppable='true']"
	Then I click on element having xpath /html/body/div[2]/div/main/section/header/section/div[2]/div/div[1]/span
