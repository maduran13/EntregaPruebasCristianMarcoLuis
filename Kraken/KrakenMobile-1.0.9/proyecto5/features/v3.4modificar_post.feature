...
Then I enter "KrakenModifiedPostTest" into input field having css selector "textarea"
Then I enter "KrakenModifedPostDescription" into input field having css selector ".koenig-editor__editor"
