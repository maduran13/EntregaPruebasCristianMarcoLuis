...
function generateDataPool() {
    ...
    console.log(`Se han generado ${datapool.length} objetos para el datapool`);
}
generateDataPool();
...
function iniciarScript() {
    //crear Miembro
    let valuemember = getRandomInt(0, 49);
...
`;
    fs.writeFileSync("datapoolv3-4crearmiembro.feature", datapoolmember);

    valuemember = getRandomInt(0, 49);
    ...
    fs.writeFileSync("datapoolv3-4modificarmiembro.feature", datapoolmodmember);
    ...
    fs.writeFileSync("datapoolv3-4crearpost.feature", datapoolcreatepost);
    valuemember = getRandomInt(0, 49);
    ...
    fs.writeFileSync("datapool3-4modificarpost.feature", datapoolmodpost);
    ...
    fs.writeFileSync("v2datapoolcreatemember.feature", datapoolv2createmember);
    ...
    fs.writeFileSync("v2datapoolmodmember.feature", datapoolv2modmember);
    ...
    fs.writeFileSync("v2datapoolcreatepost.feature", datapoolv2createpost);
    ...
    fs.writeFileSync("v2datapoolmodpost.feature", datapoolv2modpost);
}
