Feature: Crear Post 
    ...
    Then I enter "Consequatur quidem laboriosam ut." into input field having css selector "textarea"
    Then I enter "Nam ut non voluptate est recusandae quam voluptatum dolorem eaque. Et consectetur voluptate soluta. Consequatur consequatur ipsa rerum reprehenderit ad sit sed. Voluptatibus earum nihil atque ut odit porro. Expedita eum sed voluptatem. Et exercitationem at neque quis amet hic assumenda." into input field having css selector ".koenig-editor__editor"
